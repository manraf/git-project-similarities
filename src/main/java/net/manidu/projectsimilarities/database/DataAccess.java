package net.manidu.projectsimilarities.database;

import java.sql.SQLException;
import java.time.LocalDateTime;
import java.util.Map.Entry;

import net.manidu.projectsimilarities.model.Commit;
import net.manidu.projectsimilarities.model.Language;
import net.manidu.projectsimilarities.model.Stargazer;
